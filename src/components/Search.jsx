...
const Search = () => {
    ...
    const handleAddFavorites = () => {
        ...
        fetch("https://pokedex-6a2d8-default-rtdb.firebaseio.com/.json", {
            method: 'POST',
            body: JSON.stringify({
                "pokemon": selected,
                "favorite_moves": movements !== null ? movements : {}
            }),
            headers: {
                ...
                {isEmpty ?
                    <div className="main-card">
                        ...
                        <div className="movements-container">
                            ...
                            <small className="movements-select-text">Select max 4</small>
                        ...
                        <div className="database-button" onClick={handleAddFavorites}>Add to Pokedex</div>
                    </div>
                    :
                    <div className="main-card">
